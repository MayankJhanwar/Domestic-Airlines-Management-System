...
<head>
    <title>Displaying Aircrafts | DAMS-RDBMS Project</title>
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form">
                <span class="login100-form-title p-b-37">
                    Boeings we OWN!<br><br><h6>Displaying AIRCRAFTS</h6>
                </span>
<!--===================================PHP CODE FOR DISPLAYING AIRCRAFTS============================================================-->

                        <?php
                        echo "<table style='border: solid 1px black;'>";
                        echo "<tr><th>AcID</th><th>Capacity</th><th>MfdBy</th></tr>";
                        ...
                        try {
                            ...
                            $stmt = $conn->prepare("SELECT AcID, Capacity, MfdBy FROM Aircrafts");
                            $stmt->execute();
