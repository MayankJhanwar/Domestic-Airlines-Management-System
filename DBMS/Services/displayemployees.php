...
<head>
    <title>Displaying Employee Records | DAMS-RDBMS Project</title>
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form">
                <span class="login100-form-title p-b-37">
                  le voyage!<br><br><h6>Displaying Employee Records</h6>
                </span>
...
<!--===================================PHP CODE FOR DISPLAYING AIRCRAFTS============================================================-->
                    ...
                    echo "<tr><th>EmpID</th><th>Name</th><th>Address</th><th>Branch</th><th>Email</th></tr>";
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("select EmpID, Name, Address, Branch, Email from Employee");
                        $stmt->execute();
