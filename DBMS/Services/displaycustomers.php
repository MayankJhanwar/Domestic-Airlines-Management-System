...
<head>
    <title>Displaying Customers | DAMS-RDBMS Project</title>
    <meta charset="UTF-8">
        ...
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form">
                <span class="login100-form-title p-b-37">
                  voyage!<br><br><h6>Displaying All Customers</h6>
                </span>
<!--===================================PHP CODE FOR DISPLAYING AIRCRAFTS============================================================-->
                    <?php
                    echo "<table style='border: solid 1px black;'>";
                    echo "<tr><th>PassengerID</th><th>Name</th><th>Address</th><th>Age</th></tr>";
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("select PassengerID, Name, Address, Age from Passengers");
                        $stmt->execute();
