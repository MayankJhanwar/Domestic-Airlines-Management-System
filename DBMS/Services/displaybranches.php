...
<head>
    <title>Displaying Branches Network | DAMS-RDBMS Project</title>
    <meta charset="UTF-8">
...
<body>
<div class="container-login100" style="background-image: url('subtheme2/images/display.png');">
        <div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
            <form class="login100-form validate-form">
                <span class="login100-form-title p-b-37">
                  voyage!<br><br><h6>Displaying the Branches we SERVE</h6>
                </span>
<!--===================================PHP CODE FOR DISPLAYING AIRCRAFTS============================================================-->
                    <?php
                    echo "<table style='border: solid 1px black;'>";
                    echo "<tr><th>BranchID</th><th>Center</th><th>Address</th><th>State Code</th></tr>";
                    ...
                    try {
                        ...
                        $stmt = $conn->prepare("select BrID, Center, Address, State from branches");
                        $stmt->execute();
