...
<html lang="en">
<head>
	<title>Forgot PassengerID | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-login100" style="background-image: url('../subtheme1/images/bg-011.png');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" action="retrieveid.php" method="POST">
				<span class="login100-form-title p-b-37">
					Forgot USERID<br><br><h5>We are here to HELP!</h5>
				</span>

				<div class="wrap-input100 validate-input m-b-20" data-validate="Registered Name">
					<input class="input100" type="text" name="Username" placeholder="  Enter Your Registered Full Name">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" data-validate = "EmailID">
					<input class="input100" type="email" id="email" name="emailID" placeholder="    Enter your registered Email ID">
					<span class="focus-input100"></span>
				</div>
				...
				<div class="text-center">
					<a href="#" class="txt2 hov1">
						<br>Please ensure to keep your UniqueID safe!
					</a>
				</div>
