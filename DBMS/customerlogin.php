...
<html lang="en">
<head>
	<title>Customer Login Window | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
 ...
 die('Could not Connect My Sql:' .mysql_error());
	...
	if(isset($_POST['userid'])){
	    ...
	    if(mysqli_num_rows($result)==1){
            ...
            echo "<script> window.location.assign('BookTickets/choosingflights.php'); </script>";
	        exit();
	    }
	    else{
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" action="" method=POST>
				<span class="login100-form-title p-b-37">
					LOGIN Window<br><br><h5>You are important to us<br>Welcome Back!</h5>
				</span>

				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter your Unique EmployeeID">
					<input class="input100" type="text" name="userid" placeholder="PassengerID*">
				...
				<div class="text-center">
					<a href="forgotid/forgotUserid.php" class="txt2 hov1">
						<br>Forgot CustomerID
					</a>
				</div>

				<div class="text-center p-t-57 p-b-20">
					<span class="txt1">
						New Customer<br>Join to Our Services HERE<br> Sign up Below
					</span>
				</div>
