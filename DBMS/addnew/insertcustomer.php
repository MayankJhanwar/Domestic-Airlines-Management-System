...
<html lang="en">
<head>
	<title>Some More Details| DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form">
				<span class="login100-form-title p-b-37">
					We are<br>Happy to have you HERE!<br><br><h6>Cheers!</h6>
				</span>
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				$Age = $_POST['Age'];
				if($PassengerID !=''||$Name !=''||$Address !=''||$Age !=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "insert into Passengers(PassengerID, Name, Address, Age) values ($PassengerID, '$Name', '$Address', $Age)");
				echo "<br/><br/><span><h5>   Proceed to enter More Details!</h5><br></span>";
				}
				else{
...
<!--===============================================================================================-->	
				<div class="text-center">
				    <br>
				    <a href="../services/displayCustomers.php" class="txt2 hov1">
						View Updated Customers Database
					</a>
				    <a href="addcontact.php" class="txt2 hov1">
						<br><br>Proceed to Enter More Details
				</div>
			</form>
