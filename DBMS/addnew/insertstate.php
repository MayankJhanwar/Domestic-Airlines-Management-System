...
<html lang="en">
<head>
	<title>State Added Successfully | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				if($StID !=''||$StateName !=''||$Country !=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "insert into State (StID, StateName, Country) values ($StID, '$StateName', '$Country')");
				echo "<br/><br/><span><h5>New State added successfully!</h5><br></span>";
				}
				else{
