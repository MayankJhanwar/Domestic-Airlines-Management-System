...
<html lang="en">
<head>
	<title>Airfare Added Successfully | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				if($AfID !=''||$Route !=''||$Fare !=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "insert into AirFare(AfID, Route, Fare) values ($AfID, $Route, $Fare)");
				echo "<br/><br/><span><h5>New Airfare added successfully!</h5><br></span>";
				}
				else{
