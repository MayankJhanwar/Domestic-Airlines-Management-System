...
<html lang="en">
<head>
	<title>Adding a New Aircraft | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-login100" style="background-image: url('../subtheme1/images/addaircraft.png');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" action="insertemployee.php" method=POST>
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter full Name" required>
				...
				<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter Branch" required>
					<input class="input100" type="text" name="Branch" placeholder="Branch*">
					<span class="focus-input100"></span>
				</div>

				<div class="wrap-input100 validate-input m-b-25" data-validate = "Enter EmailID" required>
					<input class="input100" type="text" name="Email" placeholder="EmailID*">
					<span class="focus-input100"></span>
				</div>								
				...
				<div class="text-center">
				    <br>
					<a href="../services/displaybranches.php" class="txt2 hov1">
