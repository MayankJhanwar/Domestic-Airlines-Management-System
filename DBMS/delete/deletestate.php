...
<html lang="en">
<head>
	<title>Deleting State | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="container-login100" style="background-image: url('../subtheme1/images/addaircraft.png');">
		<div class="wrap-login100 p-l-55 p-r-55 p-t-80 p-b-30">
			<form class="login100-form validate-form" action="deletedstate.php" method=POST>
				<span class="login100-form-title p-b-37">
					deleting!<br>an asset<br><br><h6>Enter the following details</h6>
				</span>

				<div class="wrap-input100 validate-input m-b-20" data-validate="Enter State ID">
