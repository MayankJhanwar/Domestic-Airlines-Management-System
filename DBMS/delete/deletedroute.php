...
<html lang="en">
<head>
	<title>Route Deleted Successfully | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				if($RtID !=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "DELETE FROM Route WHERE RtID='$RtID'");
				echo "<br/><br/><span><h5>  Route deleted successfully!</h5><br></span>";
				}
				else{
