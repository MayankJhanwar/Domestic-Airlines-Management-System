...
<html lang="en">
<head>
	<title>State Deleted Successfully | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				if($StID !=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "DELETE FROM State WHERE StID='$StID'");
				echo "<br/><br/><span><h5>  State deleted successfully!</h5><br></span>";
				}
				else{
