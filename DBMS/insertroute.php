...
<html lang="en">
<head>
	<title>Route Added Successfully | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				if($RtID !=''||$From !=''||$To !=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "insert into Route(RtID, Airport, Destination) values ($RtID, '$From', '$To')");
				echo "<br/><br/><span><h5>New Route added successfully!</h5><br></span>";
				}
				else{
