...
<html lang="en">
<head>
	<title>FlightSchedule added Successfully | DAMS-RDBMS Project</title>
	<meta charset="UTF-8">
...
<!--=============================PHP Code to INSERT Data===========================================-->	
				...
				if($FlID!=''||$FlightDate!=''||$DepartureTime!='' ||$ArrivalTime!=''|| $Aircraft!=''|| $Netfare!=''){
				//Insert Query of SQL
				$query = mysqli_query($connection, "INSERT INTO Flight_Schedule FlID, FlightDate, DepartureTime, ArrivalTime, AirCraft, Netfare) VALUES ($FlID, '$FlightDate', '$DepartureTime', '$ArrivalTime', $Aircraft, $Netfare)");
				echo "<br/><br/><span><h5>New Flight-Schedule started successfully!</h5><br></span>";
				}
				else{
...
<!--===============================================================================================-->	
				<div class="text-center">
				    ...
				    <a href="../services/displayflightschedules.php" class="txt2 hov1">
						View Updated Flight-Schedules' Database
					</a>
